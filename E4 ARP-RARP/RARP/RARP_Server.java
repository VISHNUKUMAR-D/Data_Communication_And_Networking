    ...
    public static void main(String args[]){
        ...
        try{
            while(true){
                ...
                //Availability of ip address and their corresponding mac address in the server
                String ip[]={"165.165.80.80","165.165.79.1"}; 
                String[] mac={"74-4C-A1-4E-EF-12","08-8F-C3-05-E9-13"};

                //Check for the existance of the mac address given by the client
                for(int i=0; i<ip.length; i++){
                    if(data.equals(mac[i])){
